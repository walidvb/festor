...
$(document).on('rails_admin.dom_ready', function(){
	...
	var wysiwygs = $('.biography_field textarea, .description_field textarea, .body_field textarea, .about_field textarea, .infos_field textarea, .notes_field textarea, .message_field textarea');
	wysiwygs.editable({
		inlineMode: false,
		plainPaste: true,
		blockTags: {
