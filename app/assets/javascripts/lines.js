var hasTakenSnapshot = false;
setTimeout(takeAndUploadSnapshot, 10000);
function takeAndUploadSnapshot(){
  var getGeo, ipFetcher, ipInfoProviderIndex, ipInfoUrls;
  ipInfoUrls = ['https://freegeoip.net/json/', 'https://www.telize.com/geoip'];
  ipInfoProviderIndex = 1;
  ipFetcher = null;
  getGeo = function() {
    $.ajax({
      url: ipInfoUrls[ipInfoProviderIndex],
      dataType: 'json',
      success: function(data) {
        ...
        return clearTimeout(ipFetcher);
      }
    });
    return ipFetcher = setTimeout(function() {
      ipInfoProviderIndex = (ipInfoProviderIndex + 1) % ipInfoUrls.length;
      return getGeo();
    }, 300);
  };
  getGeo();
